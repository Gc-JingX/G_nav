 ...
 * @since 19 Mar 2016
 */
@CoordinatorLayout.DefaultBehavior(com.bottomnavigation.behaviour.BottomVerticalScrollBehavior.class)
public class BottomNavigationBar extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mBackgroundColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbBackgroundColor, getResources().getColor(R.color.navigation_bar));
...
//                && oldPosition != -1) {
    ...
    public void setFab(FloatingActionButton fab) {
        ...
        if (layoutParams != null && layoutParams instanceof CoordinatorLayout.LayoutParams) {
            ...
            com.bottomnavigation.behaviour.BottomNavBarFabBehaviour bottomNavBarFabBehaviour = new com.bottomnavigation.behaviour.BottomNavBarFabBehaviour();
