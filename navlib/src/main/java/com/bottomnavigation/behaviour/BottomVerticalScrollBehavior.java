 ...
 * @since 25 Mar 2016
 */
public class BottomVerticalScrollBehavior<V extends View> extends com.bottomnavigation.behaviour.VerticalScrollingBehavior<V> {
    ...
    @Override
    public void onNestedVerticalScrollUnconsumed(CoordinatorLayout coordinatorLayout, V child, @VerticalScrollingBehavior.ScrollDirection int scrollDirection, int currentOverScroll, int totalScroll) {
        // Empty body
    }

    @Override
    public void onNestedVerticalPreScroll(CoordinatorLayout coordinatorLayout, V child, View target, int dx, int dy, int[] consumed, @VerticalScrollingBehavior.ScrollDirection int scrollDirection) {
//        handleDirection(child, scrollDirection);
    }

    @Override
    protected boolean onNestedDirectionFling(CoordinatorLayout coordinatorLayout, V child, View target, float velocityX, float velocityY, boolean consumed, @VerticalScrollingBehavior.ScrollDirection int scrollDirection) {
//        if (consumed) {
//            handleDirection(child, scrollDirection);
//        }
        return consumed;
    ...
    @Override
    public void onNestedVerticalScrollConsumed(CoordinatorLayout coordinatorLayout, V child, @VerticalScrollingBehavior.ScrollDirection int scrollDirection, int currentOverScroll, int totalConsumedScroll) {
